...
class _StallDashboardPageState extends State<StallDashboardPage> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      if (productsPhotoKey != null)
        _productsPhotoUrl = await _getUrl(productsPhotoKey);
  ...
  Future<void> _close() async {
    final ok = await AppConfirmDialog.show(
      context,
      title: 'Cerrar puesto',
      message: '¿Cerrar tu puesto por hoy? No podrás reabrir hasta mañana.',
      confirmLabel: 'Cerrar',
      ...
      body: _error != null
          ...
          ? Center(
              child: Padding(
                ...
                child: Text(
                  'Este puesto no está abierto hoy.',
          ...
          : ListView(
              ...
              children: [
                ...
                _LabelsBlock(
                  ...
                  labels: (opening['rekognitionLabels'] as List?)
                      ?.cast<dynamic>(),
                ),
                const SizedBox(height: 10),
                _LabelsBlock(
                  title: 'Moderación',
                  labels: (opening['moderationLabels'] as List?)
                      ?.cast<dynamic>(),
...
class _LabelsBlock extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (list.isEmpty)
      return Text('$title: $emptyText', style: TextStyle(color: sub));
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            title,
            style: TextStyle(color: t, fontWeight: FontWeight.w700),
          ),
          const SizedBox(height: 10),
          Wrap(
            spacing: 8,
